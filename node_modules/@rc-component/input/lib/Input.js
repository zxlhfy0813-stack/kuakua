...
var _useCountDisplay = _interopRequireDefault(require("./hooks/useCountDisplay"));
var _useCountExceed = _interopRequireDefault(require("./hooks/useCountExceed"));
var _useMergedValue = _interopRequireDefault(require("./hooks/useMergedValue"));
...
const Input = /*#__PURE__*/(0, _react.forwardRef)((props, ref) => {
  ...
  const focus = option => {
    if (inputRef.current) {
      (0, _util.triggerFocus)(inputRef.current, option);
    }
  };
  ...
  const {
    setValue,
    formatValue
  } = (0, _useMergedValue.default)(props.defaultValue, props.value);
  const countConfig = (0, _useCount.default)(count, showCount);
  const {
    isOutOfRange,
    dataCount
  } = (0, _useCountDisplay.default)({
    countConfig,
    value: formatValue,
    maxLength
  });
  const getExceedValue = (0, _useCountExceed.default)({
    countConfig,
  ...
  const getInputElement = () => {
    ...
    const otherProps = (0, _util.omit)(props, ['prefixCls', 'onPressEnter', 'addonBefore', 'addonAfter', 'prefix', 'suffix', 'allowClear',
