...
declare const ResizableTextArea: React.ForwardRefExoticComponent<Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, "value" | "onResize"> & {
...
} & Pick<import("./interface").BaseInputProps, "suffix" | "allowClear"> & Pick<import("./interface").InputProps, "count" | "showCount" | "onClear"> & React.RefAttributes<ResizableTextAreaRef>>;
