...
class Mode {
  /*-- Constants --*/
  static #_ = (() => {
    (0, _defineProperty2.default)(this, "NUMERIC", new Mode(0x1, [10, 12, 14]));
    (0, _defineProperty2.default)(this, "ALPHANUMERIC", new Mode(0x2, [9, 11, 13]));
    (0, _defineProperty2.default)(this, "BYTE", new Mode(0x4, [8, 16, 16]));
    (0, _defineProperty2.default)(this, "KANJI", new Mode(0x8, [8, 10, 12]));
    (0, _defineProperty2.default)(this, "ECI", new Mode(0x7, [0, 0, 0]));
  })();
...
class Ecc {
  /*-- Constants --*/
  static #_ = (() => {
    (0, _defineProperty2.default)(this, "LOW", new Ecc(0, 1));
    (0, _defineProperty2.default)(this, "MEDIUM", new Ecc(1, 0));
    (0, _defineProperty2.default)(this, "QUARTILE", new Ecc(2, 3));
    (0, _defineProperty2.default)(this, "HIGH", new Ecc(3, 2));
