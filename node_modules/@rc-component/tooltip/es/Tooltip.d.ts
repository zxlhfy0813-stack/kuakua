import type { ActionType, AlignType, ArrowType, TriggerProps, TriggerRef } from '@rc-component/trigger';
import * as React from 'react';
export type SemanticName = 'root' | 'arrow' | 'container' | 'uniqueContainer';
export interface TooltipProps extends Pick<TriggerProps, 'onPopupAlign' | 'builtinPlacements' | 'disabled' | 'fresh' | 'mouseLeaveDelay' | 'mouseEnterDelay' | 'prefixCls' | 'forceRender' | 'popupVisible'> {
