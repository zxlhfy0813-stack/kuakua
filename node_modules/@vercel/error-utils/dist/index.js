...
const nativeGetSystemErrorMessage = import_node_util.default.getSystemErrorMessage;
const getSystemErrorMessageFallback = (errno) => {
...
const getSystemErrorMessage = nativeGetSystemErrorMessage ?? getSystemErrorMessageFallback;
const errorToStringFriendly = (error, fallback) => {
