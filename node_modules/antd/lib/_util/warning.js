 ...
 */
const useDevWarning = exports.useDevWarning = process.env.NODE_ENV !== 'production' ? component => {
  const {
    strict
...
const devUseWarning = exports.devUseWarning = useDevWarning;
