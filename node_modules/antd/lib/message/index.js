...
var _PureList = _interopRequireDefault(require("./PureList"));
...
const flushMessageQueue = () => {
  if (!message) {
    ...
    act(() => {
      (0, _util.render)(/*#__PURE__*/_react.default.createElement(GlobalHolderWrapper, {
        ref: node => {
          const {
            instance,
            sync
...
function open(config) {
  const result = (0, _util2.wrapPromiseFn)(resolve => {
    let closeFn;
    const task = {
      type: 'open',
      config,
...
const baseStaticMethods = {
  ...
  _InternalListDoNotUseOrYouWillBeFired: _PureList.default
};
