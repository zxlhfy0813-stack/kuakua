...
const genMentionsStyle = token => {
  ...
  const [varName, varRef] = (0, _genStyleUtils.genCssVar)(antCls, 'cmp-mentions');
  return {
    [componentCls]: [
    // =========================== Common ===========================
    (0, _style2.resetComponent)(token), (0, _style.genBasicInputStyle)(token, {
      largeStyle: {
        padding: 0
      },
      smallStyle: {
    ...
    // ========================== Variants ==========================
    (0, _variants.genOutlinedStyle)(token), (0, _variants.genFilledStyle)(token), (0, _variants.genBorderlessStyle)(token), (0, _variants.genUnderlinedStyle)(token),
    // ========================== Mentions ==========================
    {
      ...
      whiteSpace: 'pre-wrap',
      // ========================= Textarea =========================
      '> textarea': [(0, _style2.resetComponent)(token), (0, _style.genPlaceholderStyle)(token.colorTextPlaceholder), {
    ...
    // ========================= AllowClear =========================
    {
      '&-has-suffix': {
        '> textarea': {
          paddingInlineEnd: calc(token.paddingXXS).mul(1.5).add(token.fontSizeIcon).add(varRef('padding-inline')).equal()
        }
      }
    },
    // ========================== Disabled ==========================
