...
const Skeleton = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
  ...
  if (loading || !('loading' in props)) {
    ...
    if (hasTitle || hasParagraph) {
      ...
      if (hasParagraph) {
        ...
        paragraphNode = /*#__PURE__*/_react.default.createElement(_Paragraph.default, {
          ...paragraphProps
        });
      }
