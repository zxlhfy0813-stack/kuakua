...
type RcMenuDividerType = Extract<RcItemType, {
    type: 'divider';
}>;
type RcMenuItemGroupType = Extract<RcItemType, {
    type: 'group';
}>;
type RcMenuItemType = Extract<RcItemType, {
    type?: 'item';
}>;
type RcSubMenuType = Extract<RcItemType, {
    type?: 'submenu';
}>;
