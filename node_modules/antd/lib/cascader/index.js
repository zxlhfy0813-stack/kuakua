...
var _useIcons2 = _interopRequireDefault(require("./hooks/useIcons"));
...
const defaultSearchRender = (inputValue, path, prefixCls, fieldNames) => {
  ...
  path.forEach((node, index) => {
    ...
    if ((0, _is.isString)(label) || (0, _is.isNumber)(label)) {
...
const Cascader = /*#__PURE__*/React.forwardRef((props, ref) => {
  ...
  const {
    ...
    suffixIcon,
    contextSuffixIcon,
    searchIcon: (0, _is.isPlainObject)(showSearch) ? showSearch.searchIcon : undefined,
    contextSearchIcon,
    hasFeedback,
    feedbackIcon,
    showSuffixIcon,
