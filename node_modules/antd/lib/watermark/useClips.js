...
const useClips = () => {
  // Get single clips
  const getClips = (content, rotate, ratio, width, height, gapX, gapY) => {
    // ================= Text / Image =================
    ...
    if (content instanceof HTMLImageElement) {
      ...
      content.forEach(({
        ...
        ctx.font = (0, _utils.getCanvasFont)(font, ratio, height);
        ctx.fillStyle = font.color;
        ctx.textAlign = font.textAlign;
        ctx.fillText(text, contentWidth / 2, top);
        top += (0, _utils.getFontSize)(font, ratio) + FontGap * ratio;
      });
    }
    // ==================== Rotate ====================
