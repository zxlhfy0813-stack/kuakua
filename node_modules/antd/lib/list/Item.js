...
const Meta = exports.Meta = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  const {
...
const InternalItem = /*#__PURE__*/_react.default.forwardRef((props, ref) => {
  ...
  const isItemContainsTextNodeAndNotSingular = () => {
    ...
    const hasTextNode = childNodes.some(_is.isString);
  ...
  }, actions.map((action, i) => (/*#__PURE__*/_react.default.createElement("li", {
