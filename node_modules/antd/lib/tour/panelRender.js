...
const TourPanel = props => {
  ...
  const ariaProps = (0, _util.pickAttrs)(closable ?? {}, true);
  ...
  const mergedCloseIcon = /*#__PURE__*/_react.default.createElement("button", {
    type: "button",
    onClick: onClose,
    className: (0, _clsx.clsx)(`${prefixCls}-close`, classNames.close),
    style: styles.close,
  ...
  const headerNode = (0, _is.isReactRenderable)(title) ? (/*#__PURE__*/_react.default.createElement("div", {
  ...
  const descriptionNode = (0, _is.isReactRenderable)(description) ? (/*#__PURE__*/_react.default.createElement("div", {
