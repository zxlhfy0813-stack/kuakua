...
const Overlay = props => {
  ...
  if (!(0, _is.isReactRenderable)(title) && !(0, _is.isReactRenderable)(content)) {
    return null;
  }
  return /*#__PURE__*/React.createElement(React.Fragment, null, (0, _is.isReactRenderable)(title) && (/*#__PURE__*/React.createElement("div", {
    className: (0, _clsx.clsx)(`${prefixCls}-title`, classNames?.title),
    style: styles?.title
  }, title)), (0, _is.isReactRenderable)(content) && (/*#__PURE__*/React.createElement("div", {
...
const RawPurePanel = props => {
  ...
  const [mergedClassNames, mergedStyles] = (0, _useMergeSemantic.useMergeSemantic)([classNames], [styles], {
    props: mergedProps
  });
