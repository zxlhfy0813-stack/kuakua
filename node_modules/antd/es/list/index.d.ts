...
export type { ListItemMetaProps, ListItemMetaRef, ListItemProps, ListItemSemanticClassNames, ListItemSemanticName, ListItemSemanticStyles, } from './Item';
...
declare const InternalList: <T>(props: ListProps<T>, ref: React.ForwardedRef<HTMLDivElement>) => React.JSX.Element;
