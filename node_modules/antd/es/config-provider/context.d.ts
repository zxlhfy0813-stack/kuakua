...
export type ModalConfig = ComponentStyleConfig & Pick<ModalProps, 'classNames' | 'styles' | 'closeIcon' | 'closable' | 'centered' | 'okButtonProps' | 'cancelButtonProps' | 'mask' | 'focusable'> & {
    infoIcon?: React.ReactNode;
    successIcon?: React.ReactNode;
    errorIcon?: React.ReactNode;
    warningIcon?: React.ReactNode;
};
export type TabsConfig = ComponentStyleConfig & Pick<TabsProps, 'indicator' | 'indicatorSize' | 'moreIcon' | 'addIcon' | 'removeIcon' | 'classNames' | 'styles'> & {
    more?: Omit<MoreProps, 'popupRender'>;
};
export type AnchorStyleConfig = ComponentStyleConfig & Pick<AnchorProps, 'classNames' | 'styles'>;
export type AlertConfig = ComponentStyleConfig & Pick<AlertProps, 'variant' | 'closable' | 'closeIcon' | 'classNames' | 'styles'> & {
    successIcon?: React.ReactNode;
    infoIcon?: React.ReactNode;
    warningIcon?: React.ReactNode;
    errorIcon?: React.ReactNode;
...
export type TypographyConfig = ComponentStyleConfig & Pick<TypographyProps, 'classNames' | 'styles'>;
...
export type InputPasswordConfig = ComponentStyleConfig & Pick<PasswordProps, 'classNames' | 'styles' | 'iconRender' | 'variant'>;
export type InputSearchConfig = ComponentStyleConfig & Pick<SearchProps, 'classNames' | 'styles' | 'searchIcon' | 'variant'>;
...
export type DrawerConfig = ComponentStyleConfig & Pick<DrawerProps, 'classNames' | 'styles' | 'closeIcon' | 'closable' | 'mask' | 'focusable'>;
...
export type FormConfig = ComponentStyleConfig & Pick<FormProps, 'requiredMark' | 'colon' | 'scrollToFirstError' | 'validateMessages' | 'variant' | 'classNames' | 'styles' | 'tooltip' | 'labelAlign' | 'labelWrap'>;
...
export type SelectConfig = ComponentStyleConfig & Pick<SelectProps, 'showSearch' | 'variant' | 'classNames' | 'styles' | 'allowClear' | 'clearIcon' | 'loadingIcon' | 'menuItemSelectedIcon' | 'removeIcon' | 'suffixIcon'>;
export type SpaceConfig = ComponentStyleConfig & Pick<SpaceProps, 'size' | 'classNames' | 'styles'>;
export type TooltipConfig = Pick<TooltipProps, 'className' | 'style' | 'styles' | 'classNames' | 'arrow' | 'trigger' | 'mouseEnterDelay' | 'mouseLeaveDelay'> & {
    /**
...
export type PopoverConfig = Pick<PopoverProps, 'className' | 'style' | 'styles' | 'classNames' | 'arrow' | 'trigger' | 'mouseEnterDelay' | 'mouseLeaveDelay'>;
export type PopconfirmConfig = Pick<PopconfirmProps, 'className' | 'style' | 'styles' | 'classNames' | 'arrow' | 'trigger' | 'mouseEnterDelay' | 'mouseLeaveDelay'>;
...
export type CascaderConfig = ComponentStyleConfig & Pick<CascaderProps, 'variant' | 'styles' | 'classNames' | 'expandIcon' | 'loadingIcon' | 'removeIcon' | 'suffixIcon'> & {
...
export type DatePickerConfig = ComponentStyleConfig & Pick<DatePickerProps, 'variant' | 'classNames' | 'styles' | 'suffixIcon' | 'allowClear' | 'clearIcon'>;
export type RangePickerConfig = ComponentStyleConfig & Pick<RangePickerProps, 'variant' | 'separator'>;
export type TimePickerConfig = ComponentStyleConfig & Pick<TimePickerProps, 'variant' | 'classNames' | 'styles' | 'suffixIcon' | 'allowClear' | 'clearIcon'>;
export type TimelineConfig = ComponentStyleConfig & Pick<TimelineProps, 'classNames' | 'styles'>;
export type MentionsConfig = ComponentStyleConfig & Pick<MentionsProps, 'variant' | 'classNames' | 'styles' | 'allowClear'>;
export type UploadConfig = ComponentStyleConfig & Pick<UploadProps, 'classNames' | 'styles' | 'customRequest' | 'progress' | 'accept'>;
