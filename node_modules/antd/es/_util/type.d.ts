 ...
 * @since 5.13.0
 */
export type GetProp<T extends React.ComponentType<any> | object, PropName extends keyof GetProps<T>, Type extends 'Default' | 'Return' = 'Default'> = Type extends 'Default' ? NonNullable<GetProps<T>[PropName]> : Type extends 'Return' ? ReturnType<Extract<GetProp<T, PropName, 'Default'>, (...args: any[]) => unknown>> : never;
