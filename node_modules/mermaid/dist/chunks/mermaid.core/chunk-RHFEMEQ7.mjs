import {
  getIconStyles
} from "./chunk-5VM5RSS4.mjs";
import {
  getDiagramElement
} from "./chunk-XXDRQBXY.mjs";
import {
  setupViewPortForSVG
} from "./chunk-POPQ4Y6H.mjs";
import {
  JSON_SCHEMA,
  load
} from "./chunk-LNGE3PJU.mjs";
import {
  getRegisteredLayoutAlgorithm,
  render
} from "./chunk-CKBBP62Z.mjs";
import {
  createTooltip
...
You have to call mermaid.initialize.`
  ...
  getData() {
    ...
    const isCollapsed = /* @__PURE__ */ __name((sgId) => this.subGraphLookup.get(sgId)?.metadata?.view === "collapsed", "isCollapsed");
    const outermostCollapsed = /* @__PURE__ */ __name((sgId) => {
      let result;
