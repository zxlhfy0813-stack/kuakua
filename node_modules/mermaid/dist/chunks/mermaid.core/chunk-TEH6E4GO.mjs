...
// src/rendering-util/rendering-elements/shapes/c4LabelHelper.ts
import { select } from "d3";
var SECTION_GAP = 3;
var MIN_WRAP_WIDTH = 32;
var c4LabelHelper = /* @__PURE__ */ __name(async (parent, node, classes) => {
  ...
  const wrapWidth = node.width ? Math.max(node.width - 2 * (node.padding ?? 0), MIN_WRAP_WIDTH) : getConfig2().flowchart?.wrappingWidth ?? 200;
  ...
  const rendered = await Promise.all(
    sections.map(async (section) => {
      ...
      select(textEl).selectAll("tspan.text-inner-tspan").attr("font-weight", null).attr("font-style", null);
...
var labelHelper = /* @__PURE__ */ __name(async (parent, node, _classes) => {
  ...
  const text2 = await createText(
    ...
    {
      useHtmlLabels,
      width: node.width || node.wrappingWidth || getConfig2().flowchart?.wrappingWidth,
...
var updateNodeBounds = /* @__PURE__ */ __name((node, element, knownBounds) => {
  if (knownBounds) {
...
// src/rendering-util/rendering-elements/shapes/bucket.ts
...
async function bucket(parent, node, { config: { themeVariables } }) {
  ...
  const arc = /* @__PURE__ */ __name((rx, cy, ySign) => Array.from({ length: ARC_SEGMENTS + 1 }, (_, i) => {
...
// src/rendering-util/rendering-elements/shapes/collapsedGroup.ts
...
// src/rendering-util/rendering-elements/shapes/blockArrow.ts
...
var getDirectionKey = /* @__PURE__ */ __name((directions) => DIRECTION_ORDER.filter((direction) => directions.has(direction)).join("|") || POINT_KEY, "getDirectionKey");
var arrowPointFactories = {
  "right|left|up|down": /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: 0, y: 0 },
    { x: midpoint, y: 0 },
  ...
  "right|left|up": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: midpoint, y: 0 },
    { x: width - midpoint, y: 0 },
    { x: width, y: -height / 2 },
    { x: width - midpoint, y: -height },
  ...
  "right|left|down": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: midpoint, y: -height },
    { x: width - midpoint, y: -height },
    { x: width, y: 0 }
  ], "right|left|down"),
  "right|up|down": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: width, y: -midpoint },
    { x: width, y: -height + midpoint },
    { x: 0, y: -height }
  ], "right|up|down"),
  "left|up|down": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: width, y: 0 },
    { x: 0, y: -midpoint },
    { x: 0, y: -height + midpoint },
    { x: width, y: -height }
  ], "left|up|down"),
  "right|left": /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: 0 },
  ...
  "up|down": /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: width / 2, y: 0 },
    { x: 0, y: -padding },
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
  ...
  "right|up": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: 0, y: 0 },
    { x: width, y: -midpoint },
    { x: 0, y: -height }
  ], "right|up"),
  "right|down": /* @__PURE__ */ __name(({ height, width }) => [
    { x: 0, y: 0 },
    { x: width, y: 0 },
    { x: 0, y: -height }
  ], "right|down"),
  "left|up": /* @__PURE__ */ __name(({ height, midpoint, width }) => [
    { x: width, y: 0 },
    { x: 0, y: -midpoint },
    { x: width, y: -height }
  ], "left|up"),
  "left|down": /* @__PURE__ */ __name(({ height, width }) => [
    { x: width, y: 0 },
    { x: 0, y: 0 },
    { x: width, y: -height }
  ], "left|down"),
  right: /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: -padding },
    { x: midpoint, y: -padding },
    { x: width - midpoint, y: -padding },
    { x: width - midpoint, y: 0 },
  ...
  left: /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: 0 },
    { x: midpoint, y: -padding },
    { x: width - midpoint, y: -padding },
    { x: width - midpoint, y: -height + padding },
  ...
  up: /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
    { x: 0, y: -height + padding },
    { x: width / 2, y: -height },
  ...
  down: /* @__PURE__ */ __name(({ height, midpoint, padding, width }) => [
    { x: width / 2, y: 0 },
    { x: 0, y: -padding },
    { x: midpoint, y: -padding },
    { x: midpoint, y: -height + padding },
...
// src/rendering-util/rendering-elements/shapes/browser.ts
...
// src/rendering-util/rendering-elements/shapes/composite.ts
...
// src/rendering-util/rendering-elements/shapes/console.ts
...
// src/rendering-util/rendering-elements/shapes/person.ts
...
// src/rendering-util/rendering-elements/shapes/datastore.ts
...
// src/rendering-util/rendering-elements/shapes/folder.ts
...
async function addText3(parentGroup, inputText, yOffset, style = "", alignment = "center") {
  ...
  if (!useHtmlLabels) {
    ...
    const div = text2.children[0];
    const dv = select7(text2);
    if (alignment === "start") {
      select7(div).style("text-align", "left");
    }
    bbox = div.getBoundingClientRect();
    dv.attr("width", bbox.width);
    dv.attr("height", bbox.height);
