        ...
        this.form.baseStore.setState((prev) => ({
          ...
          fieldMetaBase: {
            ...
            [this.name]: {
              ...
              isTouched: prev.fieldMetaBase[this.name]?.isTouched ?? metaHelper.defaultFieldMeta.isTouched,
              isBlurred: prev.fieldMetaBase[this.name]?.isBlurred ?? metaHelper.defaultFieldMeta.isBlurred,
              isDirty: prev.fieldMetaBase[this.name]?.isDirty ?? metaHelper.defaultFieldMeta.isDirty
            }
          }
        }));
